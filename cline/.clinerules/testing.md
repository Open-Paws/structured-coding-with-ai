...
NEVER write tautological assertions — tests that assert output equals output. This is the single most dangerous pattern in AI-generated tests. Every assertion must encode a business rule you can explain in words: "this total equals the sum of line items because the pricing rule says X."
