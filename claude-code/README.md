...
.claude/
  rules/                   # 7 scoped rule files, activated by file path
...
- **.claude/rules/** contains 7 markdown files with optional `paths:` YAML frontmatter. Claude Code activates a rule file when the current file matches its path patterns.
