...
| `geo-seo-audit/` | geo-seo-audit | Seventeen-step GEO + SEO audit workflow including Core Web Vitals, HTML structure, semantic writing, E-E-A-T, content intent, Wikipedia/Wikidata, JSON-LD schema, meta tags, crawl budget, robots.txt, sitemap, IndexNow, topic cluster architecture, link building, brand signals, conversion optimization, analytics, defensive review, findings report (see SKILL.md for canonical steps) |
