...
**Tool identity** — Do not mention Claude Code, Graze, Cursor, Copilot, Windsurf, Cline, or any other AI coding tool in commits, PR descriptions, branch names, or code comments.
...
- Claude Code: set `includeCoAuthoredBy: false` in `~/.claude/settings.json`
